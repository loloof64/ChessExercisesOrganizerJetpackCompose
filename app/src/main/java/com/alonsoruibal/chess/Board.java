...
public class Board {
    ...
    // Added by loloof64 (start of section)

    public boolean isDrawByFiftyMovesRule() {
    ...
    public boolean isDrawByThreeFoldRepetitions() {
        int repetitions = 0;
    ...
    public boolean isDrawByMissingMaterial() {
    ...
    // End of section (added by loloof64)
